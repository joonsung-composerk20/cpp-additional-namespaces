...
namespace bMath {
    ...
    class specialCalculator {
        ...
        // for fraction equation
        int flccu, flccd, frccu, frccd,  flvctu, flvctd, frvctu, frvctd;
        string answer;
        ...
        void Fraction(void) {
            ...
            if (o == '+') {
                ...
                cout << "error:while processing fraction liear equation(This is error message)";
            }
            if  (x == y) {
             up = i + j;
             down = x;
        ...
        string fraction_Liear_Equation(void) {
            // codes
        }
